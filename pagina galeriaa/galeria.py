...
def main(page: ft.Page):
    ...
    videos = [
        ...
        {
            "titulo": "Entrada",
            "descripcion": "Los dispositivos de entrada permiten que la computadora reciba datos del usuario o de otros sistemas.",
            "extra": "Ejemplo: teclados, ratones y escáneres son dispositivos de entrada comunes.",
            "video": "https://github.com/Leonex657/videosgaleriaazul/raw/refs/heads/main/entrada.mp4",
        },
        {
            "titulo": "Salida",
            "descripcion": "Los dispositivos de salida permiten que la computadora comunique resultados al usuario o a otros sistemas.",
            "extra": "Ejemplo: monitores, impresoras y altavoces son dispositivos de salida comunes.",
            "video": "https://github.com/Leonex657/videosgaleriaazul/raw/refs/heads/main/salida.mp4",
        },
        {
            "titulo": "Memoria Principal",
            "descripcion": "Almacena datos e instrucciones que la CPU necesita para ejecutar programas.",
            "extra": "Incluye RAM (memoria de acceso aleatorio) y ROM (memoria de solo lectura).",
            "video": "https://github.com/Leonex657/videosgaleriaazul/raw/refs/heads/main/memoria%20principal.mp4",
        },
        {
    ...
    imagenes = [
        ...
        "https://raw.githubusercontent.com/Leonex657/abp/refs/heads/main/entrada.png",
        "https://raw.githubusercontent.com/Leonex657/abp/refs/heads/main/salida.png",
        "https://raw.githubusercontent.com/Leonex657/abp/refs/heads/main/Memoriaprincipal1.png",
        "https://raw.githubusercontent.com/Leonex657/abp/refs/heads/main/completofinal.png",
    ]
    ...
    def mostrar_contenido():
        ...
        botones = ft.Row(
            [
                ...
                boton_reiniciar if indice_actual[0] == len(videos) - 1 else ft.Container(width=130),
            ],
            alignment=ft.MainAxisAlignment.CENTER,
            spacing=30,
        )
